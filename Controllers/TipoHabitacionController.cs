...
namespace MorfeoWeb.Controllers
{
    public class TipoHabitacionController : Controller
    {
        ...
        public TipoHabitacionController(MorfeoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdTipoHabitacion,Tipo")] TipoHabitacion tipoHabitacion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdTipoHabitacion,Tipo")] TipoHabitacion tipoHabitacion)
        {
