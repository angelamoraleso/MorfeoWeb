...
namespace MorfeoWeb.Controllers
{
    public class MetodoPagoController : Controller
    {
        ...
        public MetodoPagoController(MorfeoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdMetodoPago,MetodoPago1")] MetodoPago metodoPago)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdMetodoPago,MetodoPago1")] MetodoPago metodoPago)
        {
